...
class DocsifyTheme extends MarkdownTheme {
    ...
    writeSummary(renderer) {
        ...
        try {
            ...
            this.application.logger.write(`[typedoc-plugin-markdown] _sidebar.md written to ${outputDirectory}`);
        } catch (e) {
            this.application.logger.write(`[typedoc-plugin-markdown] failed to write _sidebar at ${outputDirectory}`);
        }
    }
